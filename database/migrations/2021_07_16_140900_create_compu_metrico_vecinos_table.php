...
class CreateCompuMetricoVecinosTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('compu_metrico_vecinos', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('compu_metrico_vecinos');
    }
}
